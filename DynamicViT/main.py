...
def main(args):
    ...
    seed = args.seed + int(os.environ["RANK"])
    ...
    if args.model == 'convnext-t':
        ...
        pretrained = torch.load('./pretrained/convnext_tiny_1k_224_ema.pth', map_location='cpu')
        ...
        pretrained = torch.load('./pretrained/convnext_small_1k_224_ema.pth', map_location='cpu')
        ...
        pretrained = torch.load('./pretrained/convnext_base_1k_224_ema.pth', map_location='cpu')
        ...
        pretrained = torch.load('./pretrained/lvvit_m-56M-224-84.0.pth', map_location='cpu')
        teacher_model = LVViT_Teacher(
            patch_size=16, embed_dim=512, depth=20, num_heads=8, mlp_ratio=3.,
            p_emb='4_2',skip_lam=2., return_dense=True,mix_token=True
        )
        ...
        # pretrained = torch.hub.load('facebookresearch/deit:main', 'deit_base_patch16_224', pretrained=True)
        # pretrained = ViTForImageClassification.from_pretrained('facebook/deit-base-patch16-224')
        teacher_model = VisionTransformerTeacher(
            patch_size=16, embed_dim=768, depth=12, num_heads=12, mlp_ratio=4, qkv_bias=True)
        ...
        pretrained = torch.load('./pretrained/swin_small_patch4_window7_224.pth', map_location='cpu')
        teacher_model = SwinTransformer_Teacher(
            embed_dim=96,
            depths=[2, 2, 18, 2],
            num_heads=[3, 6, 12, 24],
        ...
        pretrained = torch.load('./pretrained/swin_base_patch4_window7_224.pth', map_location='cpu')
        teacher_model = SwinTransformer_Teacher(
            embed_dim=128,
            depths=[2, 2, 18, 2],
            num_heads=[4, 8, 16, 32],
